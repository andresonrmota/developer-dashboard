...
const RELEASE_URL = 'https://github.com/andresonrmota/developer-dashboard/releases/tag/v1.1.13av';
const DOWNLOAD_WINDOWS =
  'https://github.com/andresonrmota/developer-dashboard/releases/download/v1.1.13av/AgenteViagens-Setup-v1.1.13.exe';
const DOWNLOAD_MACOS =
  'https://github.com/andresonrmota/developer-dashboard/releases/download/v1.1.13av/AgenteViagens-1.1.13-macos-arm64.zip';
